...
func GenerateDDLs(current, desired *Schema) []string {
	...
	// Generate table DDLs
	ddls = append(ddls, generateTableDDLs(current, desired)...)
	
	// Generate index DDLs
	ddls = append(ddls, generateIndexDDLs(current, desired)...)

	return ddls
}

// generateTableDDLs generates DDLs for table changes
func generateTableDDLs(current, desired *Schema) []string {
	var ddls []string
...
// generateIndexDDLs generates DDLs for index changes
func generateIndexDDLs(current, desired *Schema) []string {
	var ddls []string
	...
	for indexName := range current.Indexes {
